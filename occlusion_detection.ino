...
void setup() {
  ...
  Serial.println("Stabilizing system (10s)...");
  delay(10000);
  ...
  Serial.println(baselineCurrent);
...
void loop() {
  ...
  Serial.print(baselineCurrent);

  Serial.print(" PWM:");
  Serial.print(appliedPWM);

  Serial.print(" Trend:");
  Serial.print(shortMean - longMean);

  if(preOcclusionDetected && !occlusionDetected){
    Serial.print(" [PRE]");
  }
  ...
  Serial.print(" preStreak:");
  Serial.print(preStreak);

  Serial.print(" occStreak:");
  Serial.print(occStreak);
